  ...
  return (
    <html lang="nl">
      <body>
        <Header />
        <main>{children}</main>
        <a href={siteConfig.whatsappHref} className="fixed bottom-5 right-5 z-50 grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-2xl shadow-black/50 transition hover:scale-105" aria-label="WhatsApp KVL Automotive">
